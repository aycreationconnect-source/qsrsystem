...
export const POSVerticalCategorySidebar: React.FC = () => {
  ...
  return (
    <aside className="w-56 xl:w-64 bg-white dark:bg-stone-900 border-r border-stone-200/80 dark:border-stone-800 flex flex-col h-full shrink-0 select-none z-10 transition-all">
      ...
      {/* 3. Footer: Manage Menu Button */}
      <div className="p-2.5 border-t border-stone-200/70 dark:border-stone-800 shrink-0 bg-stone-50/50 dark:bg-stone-900/50">
        <button
          type="button"
          onClick={() => navigate('/menu')}
          className="w-full px-3 py-2 rounded-xl text-xs font-bold text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 hover:bg-stone-100 dark:hover:bg-stone-800 border border-stone-200/80 dark:border-stone-750 flex items-center justify-center gap-2 cursor-pointer transition-all shadow-2xs active:scale-98"
        >
